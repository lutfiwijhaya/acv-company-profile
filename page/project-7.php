...
<body class="main-layout">
   ...
   <div class="content-layout-section">
      <div class="image-container">
         <img src="../images/project/project-7/Screenshot 2024-12-11 192506.png" alt="Project 2" class="responsive-image">
     </div>
     
      <div class="image-container">
          <img src="../images/project/project-7/FIRST-IMAGE-PROJECT-7-01.png" alt="Project 2" class="responsive-image">
      </div>
  </div>

  <div class="image-center-section"
   style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
   <img src="../images/project/project-7/IMAGE-PROJECT-7-01.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>

<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-7/IMAGE-PROJECT-7-02.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-7/IMAGE-PROJECT-7-03.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; padding-bottom: 5%; ">
<img src="../images/project/project-7/IMAGE-PROJECT-7-04.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
