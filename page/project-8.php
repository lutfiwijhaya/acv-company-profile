...
<body class="main-layout">
   ...
   <div class="content-layout-section">
      <div class="image-container">
         <img src="../images/project/project-8/Screenshot 2024-12-11 192536.png" alt="Project 2" class="responsive-image">
     </div>
     
      <div class="image-container">
          <img src="../images/project/project-8/FIRST-IMAGE-PROJECT-8-01.png" alt="Project 2" class="responsive-image">
      </div>
  </div>

  <div class="image-center-section"
   style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
   <img src="../images/project/project-8/IMAGE-PROJECT-8-01.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>

<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-8/IMAGE-PROJECT-8-02.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-8/IMAGE-PROJECT-8-03.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; padding-bottom: 5%; ">
<img src="../images/project/project-8/IMAGE-PROJECT-8-04.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
