...
<body class="main-layout">
   ...
   <div class="content-layout-section">
      <div class="image-container">
         <img src="../images/project/project-2/detail-p2.png" alt="Project 2" class="responsive-image">
     </div>
     
      <div class="image-container">
          <img src="../images/project/project-2/FIRST-IMAGE-PROJECT-2-01.png" alt="Project 2" class="responsive-image">
      </div>
  </div>

  <div class="image-center-section"
   style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
   <img src="../images/project/project-2/IMAGE-PROJECT-2-01.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>

<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-2/IMAGE-PROJECT-2-02.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-2/IMAGE-PROJECT-2-03.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; padding-bottom: 5%; ">
<img src="../images/project/project-2/IMAGE-PROJECT-2-04.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
