...
<body class="main-layout">
   ...
   <div class="content-layout-section">
      <div class="image-container">
         <img src="../images/project/project-15/Screenshot 2024-12-11 192830.png" alt="Project 2" class="responsive-image">
     </div>
     
      <div class="image-container">
          <img src="../images/project/project-15/FIRST-IMAGE-PROJECT-15-01.png" alt="Project 2" class="responsive-image">
      </div>
  </div>

  <div class="image-center-section"
   style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
   <img src="../images/project/project-15/IMAGE-PROJECT-15-01.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>

<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-15/IMAGE-PROJECT-15-02.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; ">
<img src="../images/project/project-15/IMAGE-PROJECT-15-03.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
<div class="image-center-section"
style="display: flex; justify-content: center; align-items: center;  padding-top: 5%; padding-bottom: 5%; ">
<img src="../images/project/project-15/IMAGE-PROJECT-15-04.png" alt="Centered Image" style="max-width: 60%; height: auto; border-radius: 10px;">
</div>
